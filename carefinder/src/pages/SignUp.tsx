      ...
      <main className="min-h-[80vh] flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            We sent a confirmation link to your email. Click on it to activate your account.
          </p>
    ...
    <main className="min-h-[80vh] flex items-center justify-center px-4 bg-gradient-to-br from-brand-50 to-white">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Join Carefinder to save and share hospital lists.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            <Input label="Full name" placeholder="Ada Okafor"

...
// Extends native input props with label, error, and hint support
  ...
  ({ label, error, hint, className = "", type, ...props }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-1.5 w-full">
        ...
        {/* Shows hint only when there is no error */}
